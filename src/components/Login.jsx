...
const ErrorSpan = ({ fieldErrors, field }) => {
                        ...
                        <form onSubmit={handleSubmit} className="login-form" noValidate>
                                ...
                                <>
                                    <div className="form-group">
                                        ...
                                        <input
                                            ...
                                            required
                                        />
                                        <ErrorSpan fieldErrors={fieldErrors} field="email" />
                                    </div>
                                    ...
                                    <div className="form-group">
                                        ...
                                        <ErrorSpan fieldErrors={fieldErrors} field="password" />
                                    </div>
                                    ...
                                    {!isLoginView && (
                                        <div className="form-group">
                                            ...
                                            <ErrorSpan fieldErrors={fieldErrors} field="confirmPassword" />
                                        </div>
                                    )}
                                </>
                            )}
                                ...
                                <div className="registration-step-2">
                                    ...
                                    <div className="form-row">
                                        <div className="form-group">
                                            ...
                                            <input
                                                ...
                                                required
                                            />
                                            <ErrorSpan fieldErrors={fieldErrors} field="nombres" />
                                        </div>
                                        <div className="form-group">
                                            ...
                                            <input
                                                ...
                                                required
                                            />
                                            <ErrorSpan fieldErrors={fieldErrors} field="apellidos" />
                                        </div>
                                    </div>
                                    ...
                                    <div className="form-row">
                                        <div className="form-group">
                                            ...
                                            />
                                            <ErrorSpan fieldErrors={fieldErrors} field="fechaNacimiento" />
                                        </div>
                                        <div className="form-group">
                                            <label htmlFor="dui">
                                                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: '16px', height: '16px', opacity: 0.7 }}>
                                            ...
                                            <input
                                                ...
                                                required
                                            />
                                            <ErrorSpan fieldErrors={fieldErrors} field="dui" />
                                        </div>
                                    </div>
                                    ...
                                    <div className="form-group">
                                        ...
                                        <ErrorSpan fieldErrors={fieldErrors} field="genero" />
                                    </div>
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input
                                            ...
                                            required
                                        />
                                        <ErrorSpan fieldErrors={fieldErrors} field="direccion" />
                                    </div>
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input
                                            ...
                                            required
                                        />
                                        <ErrorSpan fieldErrors={fieldErrors} field="telefono" />
                                    </div>
                                    ...
                                    <div className="form-row">
                                        <div className="form-group">
                                            ...
                                            <input
                                                ...
                                                required
                                            />
                                            <ErrorSpan fieldErrors={fieldErrors} field="emergenciaNombre" />
                                        </div>
                                        <div className="form-group">
                                            ...
                                            <input
                                                ...
                                                required
                                            />
                                            <ErrorSpan fieldErrors={fieldErrors} field="emergenciaTelefono" />
                                        </div>
                                    </div>
                                    <div className="form-group">
                                        ...
                                        <ErrorSpan fieldErrors={fieldErrors} field="emergenciaParentesco" />
                                    </div>
                            ...
                            {isLoginView && (
                                <div className="forgot-password">
                                    <button type="button" className="forgot-password-link" onClick={(e) => { e.preventDefault(); setShowResetPassword(true); }}>¿Olvidaste tu contraseña?</button>
                                </div>
                            )}
                        </form>
                    </>
